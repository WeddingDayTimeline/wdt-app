    ...
    <vs-card id="card">
      ...
      >
        ...
        <p
          ...
          been approved for your app.<br /><br />
          You may now close this window.</p
        >
      </div>
      <div
        v-if="this.$route.query.success === 'false'"
        class="inner-cont error"
      >
        <vs-button
          class="main-icon"
          radius
        ...
        <p>
          ...
          If you need further help, please don't hesitate to contact Dolan
          Internet Group for support.<br /><br />
